...
@section('title', 'Data Produk Es Batu')
                    ...
                    <table class="table table-hover align-middle w-100">
                        <thead class="table-light">
                            <tr class="text-muted fs-6 fw-bold">
                                <th class="border-0 px-3 py-3 rounded-start" style="width: 30%;">Jenis Es</th>
                                ...
                                <th class="border-0 text-center py-3" style="width: 15%;">Stok</th>
                                <th class="border-0 text-center py-3 rounded-end" style="width: 30%;">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
                            @forelse($produk as $p)
                                <tr class="border-top">
                                    ...
                                    <td class="border-0 text-center">
                                        <span class="fw-bold fs-6 {{ $p->stok_produk > 0 ? 'text-success' : 'text-danger' }}">
                                            {{ $p->stok_produk ?? 0 }}
                                        </span>
                                    </td>
