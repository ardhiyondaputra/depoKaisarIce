                    ...
                    <table class="table table-hover align-middle w-100">
                        <thead class="table-light">
                            <tr class="text-muted fs-6 fw-bold">
                                <th class="border-0 px-3 py-3 rounded-start" style="width: 30%;">Nama</th>
                                <th class="border-0 py-3" style="width: 35%;">Alamat</th>
                        ...
                        <tbody>
                                ...
                                <td class="text-center border-0">
                                    <div class="d-flex justify-content-center gap-2">
                                        ...
                                        <button class="btn btn-light btn-sm rounded-pill px-3 fw-bold border shadow-sm"
                                            ...
                                            data-bs-toggle="modal"
                                            data-bs-target="#modalEdit{{ $p->id_pelanggan }}">
                                            Edit
                                        </button>
                            ...
                            <!-- MODAL EDIT -->
                            <div class="modal fade" id="modalEdit{{ $p->id_pelanggan }}" tabindex="-1">
                                    ...
                                    <div class="modal-content rounded-4 border-0 shadow">
                                        <form action="{{ route('pelanggan.update', $p->id_pelanggan) }}" method="POST">
                                            ...
                                            <div class="modal-header border-0 p-4">
                                                <h5 class="fw-bold">Edit Data Pelanggan</h5>
